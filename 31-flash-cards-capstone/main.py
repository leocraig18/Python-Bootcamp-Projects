...
card_background = canvas.create_image(400, 264, image=front_card_image)
...
wrong_button = Button(image=cross_image, highlightthickness=0, border=0, command=next_card)
wrong_button.grid(row=1, column=0)

tick_image = PhotoImage(file="images/right.png")
right_button = Button(image=tick_image, highlightthickness=0, border=0, command=is_known)
